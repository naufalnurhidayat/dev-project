    ...
    <div class="row">
      <div class="col">
        <div class="p-5">
          ...
          <hr>
          <div class="text-center">
            <a class="small" href="<?php echo e(url('/login')); ?>">Login</a>
          </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('templates.template-login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\devProject\resources\views/createkaryawan/createkaryawan.blade.php ENDPATH**/ ?>