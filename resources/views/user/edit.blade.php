    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="p-5">
                ...
                <form method="POST" action="{{ url('/profile/{' . auth()->user()->id . '}') }}" class="user">
                  @method('patch')
                  @csrf
                  ...
                  <a href="{{ url('/profile') }}" class="btn btn-success btn-user btn-block">Kembali</a>
                </form>
              </div>
            </div>
        </div>
