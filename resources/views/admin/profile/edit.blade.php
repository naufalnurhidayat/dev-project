    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="p-5">
                ...
                <form method="POST" action="{{ url('/admin/profile/edit/' . auth()->user()->id) }}" class="user">
                  @method('patch')
                  @csrf
                  ...
                  <a href="{{ url('/admin/profile/' . auth()->user()->nama) }}" class="btn btn-success btn-user btn-block">Kembali</a>
                </form>
              </div>
            </div>
        </div>
