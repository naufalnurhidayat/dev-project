...
@section('content')
  ...
  <div class="container">
    ...
    <form action="{{ url('/po/profile/edit/'.auth()->user()->id) }}" method="POST" enctype="multipart/form-data">
      @method('patch')
      @csrf
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-5">
        ...
        <a href="{{ url('/po/profile/' . auth()->user()->nama) }}" class="btn btn-success btn-user">Kembali</a>
      </div>
    </div>
  </form>
  </div>
