    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="<?php echo e(asset('img/logotelkom.jfif')); ?>" class="rounded" width="50%">
        </div>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo e(url('/cuti/dashboard')); ?>">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/cuti')); ?>">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <a class="btn btn-primary" href="<?php echo e(url('/cuti/create')); ?>">
...
<?php /**PATH D:\Folder_iqbal\Prakerin\projek_pkl\Program_Cuti\dev-project\resources\views/templates/template-cuti.blade.php ENDPATH**/ ?>