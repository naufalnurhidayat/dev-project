  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3"><img src="<?php echo e(asset('img/logotelkom.jfif')); ?>" class="rounded" width="70%"></div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Uknown</span>
...
<?php /**PATH D:\Folder_iqbal\Prakerin\projek_pkl\Program_Cuti\dev-project\resources\views/templates/template-invetaris.blade.php ENDPATH**/ ?>