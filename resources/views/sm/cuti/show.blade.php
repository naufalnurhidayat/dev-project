...
<div class="container">
  ...
  @endif
  <a href="{{url('/sm/cuti/create')}}" class="btn btn-primary mb-3"><i class="fas fa-calendar-plus">&nbsp; Buat Pengajuan Cuti</i></a>
<!-- DataTales Example -->
          ...
          <tbody class="table table-bordered" id="tampunganIndexCuti">
            @foreach ($cuti as $c)
              <tr align="center">
                ...
                <td>
                  <a href="{{url('/sm/cuti/'.$c->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-search-plus"></i> <b>Detail</b></a>
                </td>
              </tr>
            @endforeach
          </tbody>
